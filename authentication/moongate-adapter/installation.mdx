...
description: "Step-by-step installation guide for the Moongate Adapter"
---
...
- [Configuration Options](/authentication/moongate-adapter/configuration) - Customize the adapter
